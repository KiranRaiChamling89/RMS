        ...
        ***********************************-->
        <div id="main-wrapper">
                    ...
                    <ul class="metismenu" id="menu">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false">
                                <li><a href="./list.php">List All Food Type</a></li>
                            </ul>
                        </li>
            ...
            ***********************************-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="custom-card-header">
                                        <h4 class="card-title">RMS Food Types</h4>
                                        <button type="button" class="btn mb-1 btn-primary btn-sm custom-card-btn" data-toggle="modal" data-target="#addFoodTypeModal">Add New</button>
                                    </div>
                                                        ...
                                                        if (mysqli_num_rows($data) > 0) {
                                                            ...
                                                            while($row = mysqli_fetch_assoc($data)) {?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                    <button type="button" class="btn mb-1 btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editFoodTypeModal" onclick="updateType(<?php echo '\''.$row['id'].'\',\''.$row['name'].'\',\''.$row['status'].'\''; ?>);">Edit</button>
                                                                    <button type="button" class="btn mb-1 btn-danger btn-sm" onclick="deleteType('<?php echo $row['id']; ?>');">Delete</button>
                                                                    </td>
                                                                </tr>
                                                    <?php
                                                            }
            ...
            <div class="modal fade" id="addFoodTypeModal">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Add New Food Type</h5>
                            <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                        </div>
                        <form action="./edit.php" method="POST">
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Enter Food Type" required>
                                </div>
            ...
            <div class="modal fade" id="editFoodTypeModal">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Update Food Type</h5>
                        ...
                        <form action="./update.php" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Enter Food Type" id="type_name" required>
                                </div>

                                <div class="form-group">
                                    <select class="form-control" id="type_status" name="status">
                                        <option active value="1">Active</option>
                                        <option value="0">Inactive</option>
                                    </select>
                                </div>
